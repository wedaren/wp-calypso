...
import { goBackToWpAdmin, completeFlow } from 'client/state/jetpack-connect/actions';
...
import { getFlowType, isCalypsoStartedConnection } from 'client/state/jetpack-connect/selectors';
